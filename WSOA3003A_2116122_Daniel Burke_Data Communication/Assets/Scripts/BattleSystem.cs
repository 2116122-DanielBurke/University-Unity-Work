...
public enum BattleState {  START, PLAYERMOVE, PLAYERTURN, ENEMYTURN, WON, LOST}
...
public class BattleSystem : MonoBehaviour
{
    ...
    public GameObject playerPrefab, cultistPrefab, slime01Prefab, cursedCultistPrefab;
    ...
    public bool isSlime, isCultist, isCurseCultist;
    void Start()
    {
    ...
    {
        if (isSlime)
            colObject = slime01Prefab;
        if (isCultist)
            colObject = cultistPrefab;
        if (isCurseCultist)
            colObject = cursedCultistPrefab;
       ...
       playerUnit = playerGO.GetComponent<Unit>();
        ...
        enemyGo = Instantiate(colObject, enemyBattleStation);
